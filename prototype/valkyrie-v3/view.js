...
function paneRender(){
  ...
  // MACRO 탭 클릭 시 Streamlit Cloud 대시보드 렌더링
  if(curTab==='MACRO'){
    p.innerHTML = '<div style="width:100%; height:100%; min-height:800px; background:#0b0f19; border-radius:6px; overflow:hidden;">' +
      '<iframe src="https://quantterminalpro2-h2dxkxcunskzfta9ffgyci.streamlit.app/?embed=true" width="100%" height="100%" style="border:none;" title="Streamlit Quant Engine"></iframe>' +
      '</div>';
    return;
  }
